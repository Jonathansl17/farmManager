          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Total de Cultivos</CardTitle>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Tomates - Campo 1</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">+5% vs año anterior</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <TabsContent value="calendar">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Planificación anual de siembras y cosechas</CardDescription>
            </CardHeader>
            <CardContent>
              <CropCalendar />
            </CardContent>
        ...
        <TabsContent value="performance">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Análisis de rendimiento por cultivo y temporada</CardDescription>
            </CardHeader>
            <CardContent>
              <CropPerformance />
            </CardContent>
